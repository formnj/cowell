        ...
        <div class="header_wrap">
            <div class="header_top">
                ...
                <ul class="quick_member">
                    <li><router-link to="/pc/MB_01_01_01">LOGIN</router-link></li>
                    <li><router-link to="/pc/MB_08_01_01">JOIN</router-link></li>
                    <li><router-link to="">INFO</router-link></li>
                    <li><router-link to="/pc/MY_01_01_01">MY</router-link></li>
                </ul>
            </div>
            <div class="header_btm">
                ...
                <ul class="quick_sites" v-if="$route.path.split('/')[2] != 'DP_01_01_01'">
                    <li><router-link to="/pc/DP_06_01_01"><img src="@/assets/images/pc/common/brand_fifa.png" alt="FIFA Official Licensed Product" /></router-link></li>
                ...
                <ul class="quick_pages">
                    ...
                    <!-- //23.03.28 검색팝업 노출 시 body 고정 -->
                    <li>
                        <router-link to="/pc/OD_01_02_01" class="cart"></router-link>
