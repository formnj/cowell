        ...
        <div class="content mypage">
            ...
            <div class="layout right">
                ...
                <div class="sorting_box">
                    <Inputs input_type="checkbox" id="" text="전체선택"/>
                    <div class="buttons ml_auto">
                        <button type="button" class="active">선택삭제</button>
                    </div>
                </div>
                    ...
                    <ul>
                        <li v-for="item in 10">
                            <div class="goods_item">
                                <a href="#none">
                                    <span class="thumb"><em><img src="/img/sam_goods_list_02.baf759f0.jpg"></em></span>
                                </a>
                                <div class="cont">
                                    <a href="#none" class="title">
                                        <strong>Nike</strong>
                                        <span>나이키 에어나이키 에어나이키 에어나이키 에어나이키 에어나이키 에어</span>
                                        <Inputs input_type="checkbox" id="" class="input_select"/>
                                    </a>
                                    <strong class="price"><em class="discount">45%</em> 250,000 </strong>
                                </div>
...
.goods_item_list > ul > li{display:inline-block;width:calc((100% - 80px) / 5);margin-right:20px;margin-bottom:60px;vertical-align:top;}
.goods_item_list > ul > li:nth-child(5n){margin-right:0;}
.goods_item .input_select{position:absolute;top:0;right:0;}
</style>