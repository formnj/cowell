<template>
    <div class="content policy_wrap">
        ...
        <ul>
            <li>
                <strong>제1조(목적) 이 약관은 코웰패션주식회사 (전자상거래 사업자)가 운영하는 코웰패션닷컴 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.</strong>
                <p>※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」</p>
            </li>
            <li>
                <strong>제2조(정의)</strong>
                <ul>
                    <li>① “몰”이란 코웰패션주식회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</li>
            ...
            <li>
                ...
                <ul>
                    <li>① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호?모사전송번호?전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 코웰패션닷컴 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>⑤ “몰”은 웹사이트의 모든 가격 정보가 정확히 유지되도록 노력합니다.  그러나 경우에 따라서는 오류(가령 오타나 그와 유사한 실수)가 발생할 수 있고 제품의 가격이 잘못 매겨질 수 있습니다.  제품의 올바른 가격이 웹사이트에 표시된 가격과 다른 경우 “몰”은 고객에게 연락하여 기존 주문을 취소하고 정상가격으로 새로 주문을 할 것인지 문의하거나, 고객의 주문을 승낙하지 않을 수 있습니다. “몰”은 주문 내용의 일부를 구성하는 제품의 가격이 오류로 인하여 부정확한 경우에는 주문을 승낙할 의무를 지지 않습니다.</li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>④ “몰”이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게 이를 통지합니다.</li>
                    <li>⑤ 회원 탈퇴시 미사용한 적립금 및 쿠폰은 즉시 소멸되며, 탈퇴 후 재가입하더라도 소멸된 적립금은 복구되지 아니합니다.</li>
                </ul>
            </li>
            <li>
            ...
            <li>
                <strong>제9조(구매신청) “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다. 단, 회원인 경우 제2호 내지 제4호의 적용을 제외할 수 있습니다.</strong>
                <ul>
                    <li>
                        <ul>
            ...
            <li>
                <strong>제11조(지급방법) “몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각호의 방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.</strong>
                <ul>
                    <li>
                        <ul>
            ...
            <li>
                <strong>제12조(수신확인통지 및 구매신청 변경 및 취소)</strong>
                <ul>
            ...
            <li>
                <strong>제14조(환급) “몰”은 이용자가 구매신청한 재화등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 2영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.</strong>
            </li>
            <li>
            ...
            <li>
                ...
                <ul>
                    <li>① “몰”은 이용자의 정보수집시 구매계약 이행에 필요한 최소한의 정보를 수집합니다. 다음 사항을 필수사항으로 하며 그 외 사항은 선택사항으로 합니다.</li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>③ “몰”이 상품이나 용역에 대하여 「표시?광고의공정화에관한법률」 제3조 소정의 부당한 표시?광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다. “몰”은 이용자가 원하지 않는 영리목적의 광고성 전자우편을 발송하지 않습니다.</li>
                </ul>
            </li>
            <li>
            ...
            <li>
                <strong>제20조(이용자의 의무) 이용자는 다음 행위를 하여서는 안됩니다.</strong>
                <ul>
                    <li>
                        <ul>
