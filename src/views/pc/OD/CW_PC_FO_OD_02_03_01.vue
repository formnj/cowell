...
import Addshipping from "@/views/pc/OD/CW_PC_FO_OD_02_03_02";
...
<style scoped>
ul {margin-top:26px; border-bottom:1px solid #ddd;}
ul + .check {margin-top:20px;}
li {padding:30px 0; border-top:1px solid #ddd; position:relative;}
li div {margin-top:10px; font-size:16px;}
li div strong {margin-right:14px;}
li div p {margin:10px 0; color:#888;}
li::v-deep .label {color:#222;}
li.active::v-deep .label {font-weight:700;}
li .btn_info {position:absolute; bottom:30px; right:0;}
li .btn_info em {width:92px; font-weight:400;}

.new_shiiping {padding-right:19px; font-size:16px; position:relative;}
