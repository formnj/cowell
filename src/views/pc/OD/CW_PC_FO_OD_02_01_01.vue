    ...
    <div class="content">
        ...
        <div class="order_wrap">
            <div class="list_wrap">
                ...
                <h3>배송지 정보
                    <div>
                        <Inputs input_type="checkbox" text="새로 입력" />
                ...
                <h3>
                    환불계좌 정보
                    <div>
                        <button type="button" class="no_arrow">환불계좌 변경</button>
                    </div>
                </h3>
                ...
                <div class="inner">
                    <dl>
                        ...
                        <dd>
                            <ul>
                                <li>
                                    <Inputs input_type="checkbox" id="아이디" text="회원 개인정보 수집 및 이용 동의" required_type="requierd" required_txt="(필수)" />
                                    <a href="#none" class="see_more" @click.prevent="openModal('modalSkin'), modalTitle='회원 개인정보 수집 및 이용 동의', modalContent='policy'">더보기</a>
                                </li> 
                                <li>
...
h3 button.no_arrow{padding-right:0;}
h3 button.no_arrow:after{content:none;}
