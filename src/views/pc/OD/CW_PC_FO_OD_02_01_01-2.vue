            ...
            <div class="list_wrap">
                ...
                <div class="order_info">
                    ...
                    <div class="list_bullet mt30">
                        <ul>
                            <li>선물 결제 완료 시 선물 안내 알림톡 또는 문자 메시지가 선물 수령인에게 발송됩니다.</li>
                            <li>수령인의 이름은 반드시 실명으로 입력되어야 합니다.</li>
                            <li>수령인은 회원가입 후 선물 수락이 가능합니다.</li>
                            <li>수령인은 선물 수락과 함께 배송지를 입력할 수 있습니다.</li>
                            <li>수령인이 선물을 거절할 경우 자동으로 주문이 취소됩니다.</li>
                            <li>선물은 재고에 따라 품절될 수 있습니다.</li>
                            <li>수령인을 잘못 지정하여 다른 사람에게 발송된 경우 책임은 결제자(주문자)에게 있으며, 환불되지 않습니다.</li>
                        </ul>
                    </div>
                </div>
                <!-- //선물하기 -->
