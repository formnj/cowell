<template>
    <div class="cate_wrap content">
        ...
        <div class="right_frame">
            <div class="tit_wrap">
                <h3>지금 제일 잘나가는 베스트 상품</h3>
                <div class="option_wrap">
                    <button type="button" class="button_sort_count" @click.prevent="openModal('modalSkin'), modalTitle='베스트 집계 기준'">베스트 상품 집계 기준</button>
...
.cate_wrap .tit_wrap {align-items:baseline;}
...
.left_frame .filter_wrap {margin-top:20px; padding-top:40px; border-top:2px solid #222;}
/* 23.05.10 수정 */
