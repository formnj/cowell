    ...
    <div>
                        ...
                        <dd class="order_info">
                            <ul class="form_group">
                                ...
                                <li>
                                    ...
                                    <Inputs input_type="text" placeholder="선물 보낼 메시지 입력" />
                                </li>
                            </ul>
                            ...
                            <dl class="tip_box">
                                <dt>선물하기 안내</dt>
                                <dd>
                                    <p>선물 결제 완료 시 선물 안내 알림톡 또는 문자 메시지가 선물 수신인에게 발송됩니다.</p>
                                    <p>수신인의 이름은 반드시 실명으로 입력되어야 합니다.</p>
                                    <p>수신인은 회원가입 후 선물 수락이 가능합니다.</p>
                                    <p>수신인은 선물 수락과 함께 배송지를 입력할 수 있습니다.</p>
                                    <p>수신인이 선물을 거절할 경우 자동으로 주문이 취소됩니다.</p>
                                    <p>선물은 재고에 따라 품절될 수 있습니다.</p>
                                    <p>수신인을 잘못 지정하여 다른 사람에게 발송된 경우 책임은 결제자(주문자)에게 있으며, 환불되지 않습니다.</p>
                                </dd>
                            </dl>
                        </dd>
                        <!-- //선물하기 -->
        ...
        <ModalSkin :modalTitle="modalTitle" :modalClass="[modalClass === ''? 'full': modalClass]">
            ...
            <div class="modal_bottom btnSection" slot="bottom" v-if="modalContent == 'CouponList'">
                <a href="#none" class="btn_big btn_default"><em>적용</em></a>
            </div>
            <!-- //쿠폰조회/적용 -->
