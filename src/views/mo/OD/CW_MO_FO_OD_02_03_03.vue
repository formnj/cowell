...
::v-deep .tab_type_03 > li a {height:auto; padding-bottom:11px; font-size:18px; font-weight:500; line-height:inherit; text-align:center;}
...
.item div button:after {width:40px; height:40px; background-image:url('@/assets/images/mo/sub/icon_coupon_type.png'); background-position:0 0; background-repeat:no-repeat; background-size:40px auto;content:''; display:block;}
...
.item.download div button:after {width:24px; height:24px; background:url('@/assets/images/mo/sub/icon_down.png') 0 0 no-repeat; background-size:24px auto;}
...
.item .explain em:after {width:14px; height:14px; margin-top:-2px; margin-left:2px; background:url('@/assets/images/mo/common/icon_exclamation_gray.png') 0 0 no-repeat; background-size:cover; vertical-align:middle; content:''; display:inline-block;}

.disabled .item *, .item .explain em  {color:#aaa;}
.disabled .item .explain em:after {background-image:url('@/assets/images/mo/common/icon_exclamation_lightgray.png');}
.disabled .item div button {background-color:#999;}
.disabled .item div button:after {display:none;}

.no_coupon {padding:80px 0; color:#888; font-size:14px; text-align:center;}
