        ...
        <div class="content pt0">
            ...
            <div class="section_group">
                <div class="section pb0">
                    <Tabs tabClass="tab_type_03 pb10" :tab_item="tab_item_gift" :tabidx="tabidx3" />
                        ...
                        <li v-for="(item, index) in cart" :key="index" class="goods_item" :class="{'disabled' : item.status == 'soldout'}">
                            <div class="inner">
                                ...
                                <div class="cont">
                                    ...
                                    <!-- <span class="badge b3">선물반려</span> -->
                                    <!-- <span class="badge b4">선물거절</span> -->
                                    <!-- <span class="badge b6">수령완료</span> -->
                                    <!-- <span class="badge b7">수령가능</span> -->
                                </div>
                            </div>
                        </li>
                    </ul>
