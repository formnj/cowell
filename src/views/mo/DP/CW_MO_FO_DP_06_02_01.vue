<template>
    <div>
        ...
        <div class="content">
            ...
            <div class="cate_top">
                <div class="cate_box">
                    <button @click.prevent="openModal('modalSkin'), modalContent='CateModal'">여성 / 아우터</button>
                </div>
                <div class="sort_box">
                    <div>
                        <!-- 선택된 필터값이 있는 경우 노출 -->
...
.cate_top .sort_box {margin-bottom:30px; padding-top:23px;}
